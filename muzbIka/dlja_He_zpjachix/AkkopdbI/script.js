...
alert("Для правой руки,запишите 
интервалы относительно верхней ноты сверху вниз.\ 
\nДля левой руки записывайте ноты относительно нижней ноты.\ 
\nЕсли есть изменение, оно записывается перед разрывом.\ 
\nВы можете нажать 'Enter', чтобы оценить свой ответ и 
ключ, чтобы указать ' . ', чтобы показать новый аккорд.\ 
